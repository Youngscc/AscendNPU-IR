"builtin.module"() ({
  ...
  ^bb0(%arg0: i64, %arg1: memref<?xi8>, %arg2: memref<?xi8>, %arg3: memref<?xbf16>, %arg4: memref<?xi8>, %arg5: memref<?xbf16>, %arg6: memref<?xi8>, %arg7: memref<?xbf16>, %arg8: i32, %arg9: i32, %arg10: i32):
    ...
    %11 = "memref.alloc"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<16x32xbf16>
    "hivm.hir.load"(%10, %11) <{init_out_buffer = false, may_implicit_transpose_with_last_axis = false, operandSegmentSizes = array<i32: 1, 1, 0, 0, 0, 0>, tcoretype = #hivm.tcore_type<VECTOR>}> : (memref<16x32xbf16, strided<[32, 1]>>, memref<16x32xbf16>) -> ()
    %12 = "bufferization.to_tensor"(%11) <{restrict, writable}> : (memref<16x32xbf16>) -> tensor<16x32xbf16>
    %13 = "memref.reinterpret_cast"(%arg5) <{operandSegmentSizes = array<i32: 1, 0, 0, 0>, static_offsets = array<i64: 0>, static_sizes = array<i64: 32, 16>, static_strides = array<i64: 16, 1>}> : (memref<?xbf16>) -> memref<32x16xbf16, strided<[16, 1]>>
    %14 = "memref.alloc"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<32x16xbf16>
    "hivm.hir.load"(%13, %14) <{init_out_buffer = false, may_implicit_transpose_with_last_axis = false, operandSegmentSizes = array<i32: 1, 1, 0, 0, 0, 0>, tcoretype = #hivm.tcore_type<VECTOR>}> : (memref<32x16xbf16, strided<[16, 1]>>, memref<32x16xbf16>) -> ()
    ...
    %131 = "hivm.hir.vcast"(%12, %130) <{broadcast = array<i64>, cast = #hivm.cast<cast_signed>, operandSegmentSizes = array<i32: 1, 1, 0>, round_mode = #hivm.round_mode<rint>, transpose = array<i64>}> : (tensor<16x32xbf16>, tensor<16x32xf32>) -> tensor<16x32xf32>
