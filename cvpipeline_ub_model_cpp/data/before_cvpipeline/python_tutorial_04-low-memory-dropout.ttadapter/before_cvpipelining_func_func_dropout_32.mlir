"builtin.module"() ({
  ...
  ^bb0(%arg0: i64, %arg1: memref<?xi8>, %arg2: memref<?xi8>, %arg3: memref<?xf32>, %arg4: memref<?xi32>, %arg5: memref<?xf32>, %arg6: i32, %arg7: f32, %arg8: i32, %arg9: i32, %arg10: i32):
    ...
    %42 = "hivm.hir.vdiv"(%32, %41, %19) <{broadcast = array<i64>, operandSegmentSizes = array<i32: 2, 1, 0>, transpose = array<i64>}> : (tensor<1024xf32>, f32, tensor<1024xf32>) -> tensor<1024xf32>
    ...
    %46 = "hivm.hir.vcmp"(%43, %3, %45) <{broadcast = array<i64>, compare_mode = #hivm.compare_mode<eq>, operandSegmentSizes = array<i32: 2, 1>, transpose = array<i64>}> : (tensor<1024xf32>, f32, tensor<1024xi1>) -> tensor<1024xi1>
