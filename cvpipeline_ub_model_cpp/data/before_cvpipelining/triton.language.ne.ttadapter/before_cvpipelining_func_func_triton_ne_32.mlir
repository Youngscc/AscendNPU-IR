"builtin.module"() ({
  ...
  ^bb0(%arg0: i64, %arg1: memref<?xi8>, %arg2: memref<?xi8>, %arg3: memref<?xi32>, %arg4: memref<?xi32>, %arg5: memref<?xi8>, %arg6: i32, %arg7: i32, %arg8: i32):
    ...
    ^bb0(%arg9: i32):
      ...
      %35 = "tensor.empty"() : () -> tensor<32xi1>
      %36 = "hivm.hir.vcmp"(%28, %33, %35) <{broadcast = array<i64>, compare_mode = #hivm.compare_mode<eq>, operandSegmentSizes = array<i32: 2, 1>, transpose = array<i64>}> : (tensor<32xi32>, tensor<32xi32>, tensor<32xi1>) -> tensor<32xi1>
      %37 = "hivm.hir.vnot"(%36, %34) <{broadcast = array<i64>, operandSegmentSizes = array<i32: 1, 1, 0>, transpose = array<i64>}> : (tensor<32xi1>, tensor<32xi1>) -> tensor<32xi1>
      %38 = "memref.reinterpret_cast"(%arg5, %18) <{operandSegmentSizes = array<i32: 1, 1, 0, 0>, static_offsets = array<i64: -9223372036854775808>, static_sizes = array<i64: 32>, static_strides = array<i64: 1>}> : (memref<?xi8>, index) -> memref<32xi8, strided<[1], offset: ?>>
      %39 = "tensor.empty"() : () -> tensor<32xi8>
      %40 = "hivm.hir.vcast"(%37, %39) <{broadcast = array<i64>, cast = #hivm.cast<cast_signed>, operandSegmentSizes = array<i32: 1, 1, 0>, round_mode = #hivm.round_mode<rint>, transpose = array<i64>}> : (tensor<32xi1>, tensor<32xi8>) -> tensor<32xi8>
      %41 = "tensor.extract_slice"(%40, %24) <{operandSegmentSizes = array<i32: 1, 0, 1, 0>, static_offsets = array<i64: 0>, static_sizes = array<i64: -9223372036854775808>, static_strides = array<i64: 1>}> : (tensor<32xi8>, index) -> tensor<?xi8>
      %42 = "memref.subview"(%38, %24) <{operandSegmentSizes = array<i32: 1, 0, 1, 0>, static_offsets = array<i64: 0>, static_sizes = array<i64: -9223372036854775808>, static_strides = array<i64: 1>}> : (memref<32xi8, strided<[1], offset: ?>>, index) -> memref<?xi8, strided<[1], offset: ?>>
      "hivm.hir.store"(%41, %42) : (tensor<?xi8>, memref<?xi8, strided<[1], offset: ?>>) -> ()
      "scf.yield"() : () -> ()
    }) : (i32, i32, i32) -> ()
    "func.return"() : () -> ()
