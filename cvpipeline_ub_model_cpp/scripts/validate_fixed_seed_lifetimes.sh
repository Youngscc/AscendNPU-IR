...
SNAPSHOT_ROOT="${PLANMEMORY_FIXED_SEED_SNAPSHOT_ROOT:-${MODULE_DIR}/output/snapshots}/lifetime"
REPORT_TAG="${PLANMEMORY_FIXED_SEED_REPORT_TAG:-}"
REPORT_NAME="fixed_seed_lifetime_validation${REPORT_TAG:+_${REPORT_TAG}}.tsv"
