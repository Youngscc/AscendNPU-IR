#!/usr/bin/env python3
"""Generate named PlanMemory-before fixtures for exact validation."""
...
SOURCE_CASES = {
    "control_while_scalar_live": "test_scfwhileop",
    "control_while_ub_loop_carried": "test_scfwhileop_yield_inplace",
    "control_while_do_while_ub": "test_dowhile_yield_inplace",
    "control_cf_diamond_single_arg": "test_branchop",
    "control_cf_diamond_multi_arg": "test_branchop_inplace",
    "control_scope_nested_iter_copy": "test_scope_copy_arg_used_after_yield_init",
    "control_preload_expand_lifetime": "test_preload_buffer_expand_lifetime",
    "alias_select_conditional": "test_select_cond_alias_not_inplace",
    "alias_multi_if_separate_results": "test_multi_if_yield_not_alias",
    "alias_if_three_results": "test_if_multi_yield_not_alias",
    "liveness_nested_if_in_for": "test_dead_after_op_nested_if_in_for",
    "alias_subview_offset_not_inplace": "test_vabs_offset_unequal_not_inplace",
    "planner_multi_buffer_no_inplace": "test_multi_buffer_loadstore_not_inplace",
    "planner_multi_buffer_level0_inplace": "test_multi_buffer_loadstore_level0_inplace",
    "planner_basic_reuse_chain": "test_mem_allocate_basic",
    "planner_zero_temp_buffer": "test_mem_noreuse_max",
    "planner_specalloc_overlap": "test_mem_specalloc_max",
    "control_if_yield_single_result": "test_infer_plan_memory_if_yield",
    "control_if_else_no_result": "test_if_else",
    "control_for_iter_if_use": "test_iter_arg_use_in_if_yield_outside",
    "control_for_result_alias": "test_plan_memory_for_result",
    "alias_subview_in_loop_multi": "test_plan_memory_subview_in_loop",
    "planner_multi_buffer_count4": "test_mem_plan_multi_address",
    "planner_multi_buffer_single_to_four": "test_inplace_single_and_mb",
    "planner_multi_buffer_four_inplace": "test_mem_inplace_mb_and_mb",
}
...
def custom_cases() -> dict[str, tuple[str, str]]:
    ...
    hivm.hir.store ins(%a33 : memref<33xi8, {ub_i8}>) outs(%dst33 : memref<33xi8, {gm_i8}>)""",
        ...
        "boundary_capacity_exact_192kib": (
            "exact",
            module(
                "boundary_capacity_exact_192kib",
    ...
    hivm.hir.store ins(%alloc : memref<196608xi8, {ub_i8}>) outs(%dst : memref<196608xi8, {gm_i8}>)""",
        ...
        "boundary_capacity_over_by_one_byte": (
            "exact",
            module(
                "boundary_capacity_over_by_one_byte",
  ...
  ^exit(%result: memref<32xf32, #hivm.address_space<ub>>):
    ...
    hivm.hir.store ins(%result#1 : memref<32xf32, #hivm.address_space<ub>>) outs(%dst1 : memref<32xf32, #hivm.address_space<gm>>)""",
        ...
        "control_scope_two_preload_buffers": (
            "exact",
            module(
                "control_scope_two_preload_buffers",
                "%src0: memref<32xf32, #hivm.address_space<gm>>, "
    ...
    scf.for %iv = %c0 to %c4 step %c1 {
      ...
      hivm.hir.store ins(%result#1 : memref<32xf32, #hivm.address_space<ub>>) outs(%dst1 : memref<32xf32, #hivm.address_space<gm>>)
        ...
        "control_cf_branches_with_scf_for": (
            "exact",
            module(
                "control_cf_branches_with_scf_for",
                "%src: memref<32xf32, #hivm.address_space<gm>>, "
...
def main() -> int:
    ...
    output_root = module_dir / "testdata/plan_memory"
    ...
    for name, (mode, text) in custom_cases().items():
        if mode != "exact":
            raise RuntimeError(f"PlanMemory fixture must be exact: {name}")
        path = exact_dir / f"{name}.mlir"
        write_fixture(path, text)
