"builtin.module"() ({
  ...
  ^bb0:
    ...
    "annotation.mark"(%cube) <{case = "cube_only"}> : (tensor<4xf32>) -> ()
    ...
    }) {hivm.loop_core_type = #hivm.loop_core_type<CUBE>, tcoretype = #hivm.tcore_type<VECTOR>} : (index, index, index, tensor<4xf32>) -> tensor<4xf32>
    ...
    }) {hivm.loop_core_type = #hivm.loop_core_type<CUBE>} : () -> tensor<4xf32>
