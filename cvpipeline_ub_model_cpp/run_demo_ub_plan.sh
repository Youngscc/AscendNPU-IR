...
# BEFORE_CVPIPELINING_IR="cvpipeline_ub_model_cpp/data/before_cvpipelining/triton.language.flip.ttadapter/before_cvpipelining_func_func_flip_kernel_32.mlir"
# BEFORE_CVPIPELINING_IR="cvpipeline_ub_model_cpp/data/before_cvpipelining/attn_fwd.ttadapter/before_cvpipelining_func_func_attn_fwd_32.mlir"
BEFORE_CVPIPELINING_IR="cvpipeline_ub_model_cpp/data/before_cvpipelining/python_tutorial_09-persistent-matmul.ttadapter/before_cvpipelining_func_func_matmul_kernel_32.mlir"
# BEFORE_CVPIPELINING_IR="cvpipeline_ub_model_cpp/data/before_cvpipelining/triton.language.randn.ttadapter/before_cvpipelining_func_func_kernel_randn_32.mlir"
OUTPUT_ROOT="cvpipeline_ub_model_cpp/output/demo"
DEMO_JSON=""
DEMO_HTML=""
ORACLE_DIR=""
...
model_args=(
  python3 cvpipeline_ub_model_cpp/scripts/plan_before_cvpipelining_ub.py
