...
// RUN: bishengir-opt %s -hacc-append-device-spec=target=Ascend910B1 -hivm-plan-memory=enable-print-memory-allocated-size=true -split-input-file -verify-diagnostics | FileCheck %s --check-prefix=UB
