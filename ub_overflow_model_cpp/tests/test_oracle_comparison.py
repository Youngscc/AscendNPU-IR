...
PLANMEM_EXACT_BUFFER\t1\tunused\t65536\t6\t0\t-1\t-1
...
assert lifetimes == collections.Counter({("kernel", 32768, 0, 0, 1): 1})
...
PLANMEM_EXACT_BUFFER\t0\tunused\t65536\t6\t0\t-1\t-1
...
with tempfile.TemporaryDirectory(prefix="cvub-oracle-test-") as directory:
    ...
    _, _, oracle_plan, oracle_lifetimes = parse_oracle(path, 0, "6")
