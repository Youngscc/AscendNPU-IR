...
model_main = read("ub_overflow_model_cpp/src/main.cpp")
model_pipeline = read(
    "ub_overflow_model_cpp/src/pipeline/cvpipelining_ub_pipeline.hpp"
)
model_wrapper = read(
    "ub_overflow_model_cpp/scripts/plan_before_cvpipelining_ub.py"
)
demo_script = read("ub_overflow_model_cpp/run_demo_ub_plan.sh")
corpus_script = read("ub_overflow_model_cpp/scripts/run_corpus_oracle.py")
