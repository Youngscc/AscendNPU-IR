...
"${compiler}" -std=c++17 -O0 -g -Wall -Wextra -Wpedantic -Wconversion \
  -Wshadow -Werror \
  ub_overflow_model_cpp/tests/test_second_func_extended_canonicalizer.cpp \
  -o ub_overflow_model_cpp/output/tests/test_second_func_extended_canonicalizer
ub_overflow_model_cpp/output/tests/test_second_func_extended_canonicalizer

"${compiler}" -std=c++17 -O0 -g -Wall -Wextra -Wpedantic -Wconversion \
  -Wshadow -Werror \
  ub_overflow_model_cpp/tests/test_pre_cv_memref_dse.cpp \
  -o ub_overflow_model_cpp/output/tests/test_pre_cv_memref_dse
ub_overflow_model_cpp/output/tests/test_pre_cv_memref_dse

"${compiler}" -std=c++17 -O0 -g -Wall -Wextra -Wpedantic -Wconversion \
  -Wshadow -Werror \
  ub_overflow_model_cpp/tests/test_pre_cv_inline_otf_broadcast.cpp \
  -o ub_overflow_model_cpp/output/tests/test_pre_cv_inline_otf_broadcast
ub_overflow_model_cpp/output/tests/test_pre_cv_inline_otf_broadcast
...
python3 ub_overflow_model_cpp/tests/test_before_auto_boundary_measurement.py
