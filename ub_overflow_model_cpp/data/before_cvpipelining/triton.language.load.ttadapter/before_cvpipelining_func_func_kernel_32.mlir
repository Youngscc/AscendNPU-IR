"builtin.module"() ({
  ...
  ^bb0(%arg0: i64, %arg1: memref<?xi8>, %arg2: memref<?xi8>, %arg3: memref<?xf32>, %arg4: memref<?xf32>, %arg5: i32, %arg6: i32, %arg7: i32):
    ...
    %10 = "memref.reinterpret_cast"(%arg4, %9) <{operandSegmentSizes = array<i32: 1, 1, 0, 0>, static_offsets = array<i64: -9223372036854775808>, static_sizes = array<i64: 128>, static_strides = array<i64: 1>}> : (memref<?xf32>, index) -> memref<128xf32, strided<[1], offset: ?>>
    %11 = "memref.alloc"() <{operandSegmentSizes = array<i32: 0, 0>}> : () -> memref<128xf32>
    "hivm.hir.load"(%10, %11) <{eviction_policy = #hivm.eviction_policy<EvictFirst>, init_out_buffer = false, may_implicit_transpose_with_last_axis = false, operandSegmentSizes = array<i32: 1, 1, 0, 0, 0, 0>, tcoretype = #hivm.tcore_type<VECTOR>}> : (memref<128xf32, strided<[1], offset: ?>>, memref<128xf32>) -> ()
    %12 = "bufferization.to_tensor"(%11) <{restrict, writable}> : (memref<128xf32>) -> tensor<128xf32>
    %13 = "memref.reinterpret_cast"(%arg3, %9) <{operandSegmentSizes = array<i32: 1, 1, 0, 0>, static_offsets = array<i64: -9223372036854775808>, static_sizes = array<i64: 128>, static_strides = array<i64: 1>}> : (memref<?xf32>, index) -> memref<128xf32, strided<[1], offset: ?>>
    "hivm.hir.store"(%12, %13) : (tensor<128xf32>, memref<128xf32, strided<[1], offset: ?>>) -> ()
    "func.return"() : () -> ()
