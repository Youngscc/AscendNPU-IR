...
"builtin.module"() ({
  "func.func"() <{arg_attrs = [{hacc.arg_type = #hacc.arg_type<ffts_base_address>}, {hacc.arg_type = #hacc.arg_type<sync_block_lock>}, {hacc.arg_type = #hacc.arg_type<workspace>}, {tt.divisibility = 16 : i32, tt.tensor_kind = 0 : i32}, {tt.divisibility = 16 : i32, tt.tensor_kind = 2 : i32}, {tt.divisibility = 16 : i32, tt.tensor_kind = 1 : i32}, {tt.divisibility = 16 : i32}, {}, {}, {}], function_type = (i64, memref<?xi8>, memref<?xi8>, memref<?xi32>, memref<?xi32>, memref<?xi32>, i32, i32, i32, i32) -> (), sym_name = "atomic_xchg"}> ({
  ^bb0(%arg0: i64, %arg1: memref<?xi8>, %arg2: memref<?xi8>, %arg3: memref<?xi32>, %arg4: memref<?xi32>, %arg5: memref<?xi32>, %arg6: i32, %arg7: i32, %arg8: i32, %arg9: i32):
    ...
    "hivm.hir.load"(%23, %25) <{eviction_policy = #hivm.eviction_policy<EvictFirst>, init_out_buffer = false, may_implicit_transpose_with_last_axis = false, operandSegmentSizes = array<i32: 1, 1, 0, 0, 0, 0>, tcoretype = #hivm.tcore_type<VECTOR>}> : (memref<512xi32, strided<[1]>>, memref<512xi32>) -> ()
    %26 = "bufferization.to_tensor"(%25) <{restrict, writable}> : (memref<512xi32>) -> tensor<512xi32>
    "hivm.hir.atomic_xchg"(%22, %24) : (memref<?xi32, strided<[1]>>, memref<?xi32, strided<[1]>>) -> ()
    %27 = "memref.reinterpret_cast"(%arg5, %12) <{operandSegmentSizes = array<i32: 1, 1, 0, 0>, static_offsets = array<i64: -9223372036854775808>, static_sizes = array<i64: 512>, static_strides = array<i64: 1>}> : (memref<?xi32>, index) -> memref<512xi32, strided<[1], offset: ?>>
    ...
    %29 = "memref.subview"(%27, %19) <{operandSegmentSizes = array<i32: 1, 0, 1, 0>, static_offsets = array<i64: 0>, static_sizes = array<i64: -9223372036854775808>, static_strides = array<i64: 1>}> : (memref<512xi32, strided<[1], offset: ?>>, index) -> memref<?xi32, strided<[1], offset: ?>>
    "hivm.hir.store"(%28, %29) : (tensor<?xi32>, memref<?xi32, strided<[1], offset: ?>>) -> ()
    "func.return"() : () -> ()
