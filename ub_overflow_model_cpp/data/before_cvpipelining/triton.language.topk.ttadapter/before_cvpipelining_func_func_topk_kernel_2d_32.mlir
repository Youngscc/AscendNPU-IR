"builtin.module"() ({
  ...
  ^bb0(%arg0: i64, %arg1: memref<?xi8>, %arg2: memref<?xi8>, %arg3: memref<?xf32>, %arg4: memref<?xf32>, %arg5: i32, %arg6: i32, %arg7: i32):
    ...
    "hivm.hir.load"(%14, %15) <{eviction_policy = #hivm.eviction_policy<EvictFirst>, init_out_buffer = false, may_implicit_transpose_with_last_axis = false, operandSegmentSizes = array<i32: 1, 1, 0, 0, 0, 0>, tcoretype = #hivm.tcore_type<VECTOR>}> : (memref<2x2x2xf32, strided<[4, 2, 1], offset: ?>>, memref<2x2x2xf32>) -> ()
    ...
    %53 = "hivm.hir.vreduce"(%39, %52) <{arith = #hivm.reduce_op<xori>, operandSegmentSizes = array<i32: 1, 1, 0, 0>, reduce_dims = array<i64: 2>, tie_break_left = true, unsigned_src = false}> : (tensor<2x2x2xi32>, tensor<2x2x1xi32>) -> tensor<2x2x1xi32>
    ...
    %72 = "hivm.hir.vcmp"(%16, %62, %71) <{broadcast = array<i64>, compare_mode = #hivm.compare_mode<gt>, is_signed = true, operandSegmentSizes = array<i32: 2, 1, 0>, transpose = array<i64>}> : (tensor<2x2x2xf32>, tensor<2x2x2xf32>, tensor<2x2x2xi1>) -> tensor<2x2x2xi1>
    ...
    %88 = "hivm.hir.vcmp"(%86, %87, %70) <{broadcast = array<i64>, compare_mode = #hivm.compare_mode<eq>, is_signed = true, operandSegmentSizes = array<i32: 2, 1, 0>, transpose = array<i64>}> : (tensor<2x2x2xi32>, tensor<2x2x2xi32>, tensor<2x2x2xi1>) -> tensor<2x2x2xi1>
    ...
    %93 = "hivm.hir.vreduce"(%91, %92) <{arith = #hivm.reduce_op<xori>, operandSegmentSizes = array<i32: 1, 1, 0, 0>, reduce_dims = array<i64: 1>, tie_break_left = true, unsigned_src = false}> : (tensor<2x2x2xi32>, tensor<2x1x2xi32>) -> tensor<2x1x2xi32>
    ...
    %100 = "hivm.hir.vcmp"(%90, %99, %68) <{broadcast = array<i64>, compare_mode = #hivm.compare_mode<gt>, is_signed = true, operandSegmentSizes = array<i32: 2, 1, 0>, transpose = array<i64>}> : (tensor<2x2x2xf32>, tensor<2x2x2xf32>, tensor<2x2x2xi1>) -> tensor<2x2x2xi1>
    ...
    %116 = "hivm.hir.vcmp"(%114, %115, %67) <{broadcast = array<i64>, compare_mode = #hivm.compare_mode<eq>, is_signed = true, operandSegmentSizes = array<i32: 2, 1, 0>, transpose = array<i64>}> : (tensor<2x2x2xi32>, tensor<2x2x2xi32>, tensor<2x2x2xi1>) -> tensor<2x2x2xi1>
    ...
    %121 = "hivm.hir.vreduce"(%119, %120) <{arith = #hivm.reduce_op<xori>, operandSegmentSizes = array<i32: 1, 1, 0, 0>, reduce_dims = array<i64: 2>, tie_break_left = true, unsigned_src = false}> : (tensor<2x2x2xi32>, tensor<2x2x1xi32>) -> tensor<2x2x1xi32>
    ...
    %128 = "hivm.hir.vcmp"(%118, %127, %65) <{broadcast = array<i64>, compare_mode = #hivm.compare_mode<gt>, is_signed = true, operandSegmentSizes = array<i32: 2, 1, 0>, transpose = array<i64>}> : (tensor<2x2x2xf32>, tensor<2x2x2xf32>, tensor<2x2x2xi1>) -> tensor<2x2x2xi1>
    ...
    %144 = "hivm.hir.vcmp"(%142, %143, %64) <{broadcast = array<i64>, compare_mode = #hivm.compare_mode<eq>, is_signed = true, operandSegmentSizes = array<i32: 2, 1, 0>, transpose = array<i64>}> : (tensor<2x2x2xi32>, tensor<2x2x2xi32>, tensor<2x2x2xi1>) -> tensor<2x2x2xi1>
    ...
    %150 = "hivm.hir.vreduce"(%146, %149) <{arith = #hivm.reduce_op<max>, operandSegmentSizes = array<i32: 1, 1, 0, 0>, reduce_dims = array<i64: 0>, tie_break_left = true, unsigned_src = false}> : (tensor<2x2x2xf32>, tensor<1x2x2xf32>) -> tensor<1x2x2xf32>
    ...
    %154 = "hivm.hir.vreduce"(%152, %153) <{arith = #hivm.reduce_op<xori>, operandSegmentSizes = array<i32: 1, 1, 0, 0>, reduce_dims = array<i64: 0>, tie_break_left = true, unsigned_src = false}> : (tensor<2x2xi32>, tensor<1x2xi32>) -> tensor<1x2xi32>
    ...
    %167 = "hivm.hir.vcmp"(%151, %160, %166) <{broadcast = array<i64>, compare_mode = #hivm.compare_mode<gt>, is_signed = true, operandSegmentSizes = array<i32: 2, 1, 0>, transpose = array<i64>}> : (tensor<2x2xf32>, tensor<2x2xf32>, tensor<2x2xi1>) -> tensor<2x2xi1>
    ...
    %181 = "hivm.hir.vcmp"(%179, %180, %165) <{broadcast = array<i64>, compare_mode = #hivm.compare_mode<eq>, is_signed = true, operandSegmentSizes = array<i32: 2, 1, 0>, transpose = array<i64>}> : (tensor<2x2xi32>, tensor<2x2xi32>, tensor<2x2xi1>) -> tensor<2x2xi1>
    ...
    %186 = "hivm.hir.vreduce"(%184, %185) <{arith = #hivm.reduce_op<xori>, operandSegmentSizes = array<i32: 1, 1, 0, 0>, reduce_dims = array<i64: 1>, tie_break_left = true, unsigned_src = false}> : (tensor<2x2xi32>, tensor<2x1xi32>) -> tensor<2x1xi32>
    ...
    %193 = "hivm.hir.vcmp"(%183, %192, %163) <{broadcast = array<i64>, compare_mode = #hivm.compare_mode<gt>, is_signed = true, operandSegmentSizes = array<i32: 2, 1, 0>, transpose = array<i64>}> : (tensor<2x2xf32>, tensor<2x2xf32>, tensor<2x2xi1>) -> tensor<2x2xi1>
    ...
    %207 = "hivm.hir.vcmp"(%205, %206, %162) <{broadcast = array<i64>, compare_mode = #hivm.compare_mode<eq>, is_signed = true, operandSegmentSizes = array<i32: 2, 1, 0>, transpose = array<i64>}> : (tensor<2x2xi32>, tensor<2x2xi32>, tensor<2x2xi1>) -> tensor<2x2xi1>
