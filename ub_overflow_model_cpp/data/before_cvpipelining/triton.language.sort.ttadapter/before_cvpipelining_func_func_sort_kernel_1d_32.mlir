"builtin.module"() ({
  ...
  ^bb0(%arg0: i64, %arg1: memref<?xi8>, %arg2: memref<?xi8>, %arg3: memref<?xi16>, %arg4: memref<?xi16>, %arg5: i32, %arg6: i32, %arg7: i32):
    ...
    "hivm.hir.load"(%11, %12) <{eviction_policy = #hivm.eviction_policy<EvictFirst>, init_out_buffer = false, may_implicit_transpose_with_last_axis = false, operandSegmentSizes = array<i32: 1, 1, 0, 0, 0, 0>, tcoretype = #hivm.tcore_type<VECTOR>}> : (memref<2xi16, strided<[1]>>, memref<2xi16>) -> ()
    ...
    %16 = "hivm.hir.vreduce"(%13, %15) <{arith = #hivm.reduce_op<xori>, operandSegmentSizes = array<i32: 1, 1, 0, 0>, reduce_dims = array<i64: 0>, tie_break_left = true, unsigned_src = false}> : (tensor<2xi16>, tensor<1xi16>) -> tensor<1xi16>
    ...
    %33 = "hivm.hir.vcmp"(%13, %29, %32) <{broadcast = array<i64>, compare_mode = #hivm.compare_mode<gt>, is_signed = true, operandSegmentSizes = array<i32: 2, 1, 0>, transpose = array<i64>}> : (tensor<2xi16>, tensor<2xi16>, tensor<2xi1>) -> tensor<2xi1>
    ...
    %43 = "hivm.hir.vcmp"(%42, %41, %31) <{broadcast = array<i64>, compare_mode = #hivm.compare_mode<eq>, is_signed = true, operandSegmentSizes = array<i32: 2, 1, 0>, transpose = array<i64>}> : (tensor<2xi32>, tensor<2xi32>, tensor<2xi1>) -> tensor<2xi1>
