...
"builtin.module"() ({
  "func.func"() <{arg_attrs = [{hacc.arg_type = #hacc.arg_type<ffts_base_address>}, {hacc.arg_type = #hacc.arg_type<sync_block_lock>}, {hacc.arg_type = #hacc.arg_type<workspace>}, {tt.divisibility = 16 : i32, tt.tensor_kind = 0 : i32}, {tt.divisibility = 16 : i32, tt.tensor_kind = 0 : i32}, {tt.divisibility = 16 : i32, tt.tensor_kind = 1 : i32}, {}, {}, {}, {}, {}], function_type = (i64, memref<?xi8>, memref<?xi8>, memref<?xf32>, memref<?xi32>, memref<?xf32>, i32, f32, i32, i32, i32) -> (), sym_name = "_dropout"}> ({
  ^bb0(%arg0: i64, %arg1: memref<?xi8>, %arg2: memref<?xi8>, %arg3: memref<?xf32>, %arg4: memref<?xi32>, %arg5: memref<?xf32>, %arg6: i32, %arg7: f32, %arg8: i32, %arg9: i32, %arg10: i32):
    ...
    %26 = "affine.max"(%21, %25) <{map = #map1}> : (index, index) -> index
    %27 = "affine.min"(%24, %26) <{map = #map1}> : (index, index) -> index
    %28 = "affine.apply"(%27, %21) <{map = #map2}> : (index, index) -> index
    ...
    "hivm.hir.load"(%35, %36, %2, %5, %29) <{eviction_policy = #hivm.eviction_policy<EvictFirst>, init_out_buffer = true, may_implicit_transpose_with_last_axis = false, operandSegmentSizes = array<i32: 1, 1, 1, 1, 0, 1>, pad_mode = #hivm.padmode<PadValue>, tcoretype = #hivm.tcore_type<VECTOR>}> : (memref<?xi32, strided<[1], offset: ?>>, memref<?xi32, strided<[1]>>, i32, index, i1) -> ()
    %37 = "bufferization.to_tensor"(%34) <{restrict, writable}> : (memref<1024xi32>) -> tensor<1024xi32>
    %38 = "tensor.insert"(%arg7, %16, %5) : (f32, tensor<1xf32>, index) -> tensor<1xf32>
    %39 = "hivm.hir.vmul"(%38, %0, %15) <{broadcast = array<i64>, operandSegmentSizes = array<i32: 2, 1, 0>, transpose = array<i64>}> : (tensor<1xf32>, f32, tensor<1xf32>) -> tensor<1xf32>
    %40 = "hivm.hir.vadd"(%39, %6, %14) <{broadcast = array<i64>, operandSegmentSizes = array<i32: 2, 1, 0>, transpose = array<i64>}> : (tensor<1xf32>, f32, tensor<1xf32>) -> tensor<1xf32>
    %41 = "tensor.extract"(%40, %5) : (tensor<1xf32>, index) -> f32
    %42 = "hivm.hir.vdiv"(%32, %41, %19) <{broadcast = array<i64>, isHP = false, isSigned = true, operandSegmentSizes = array<i32: 2, 1, 0>, transpose = array<i64>}> : (tensor<1024xf32>, f32, tensor<1024xf32>) -> tensor<1024xf32>
    %43 = "hivm.hir.vcast"(%37, %18) <{broadcast = array<i64>, cast = #hivm.cast<cast_signed>, operandSegmentSizes = array<i32: 1, 1, 0>, round_mode = #hivm.round_mode<rint>, transpose = array<i64>}> : (tensor<1024xi32>, tensor<1024xf32>) -> tensor<1024xf32>
    %44 = "tensor.empty"() : () -> tensor<1024xi1>
    %45 = "tensor.empty"() : () -> tensor<1024xi1>
    %46 = "hivm.hir.vcmp"(%43, %3, %45) <{broadcast = array<i64>, compare_mode = #hivm.compare_mode<eq>, is_signed = true, operandSegmentSizes = array<i32: 2, 1, 0>, transpose = array<i64>}> : (tensor<1024xf32>, f32, tensor<1024xi1>) -> tensor<1024xi1>
    %47 = "hivm.hir.vnot"(%46, %44) <{broadcast = array<i64>, operandSegmentSizes = array<i32: 1, 1, 0>, transpose = array<i64>}> : (tensor<1024xi1>, tensor<1024xi1>) -> tensor<1024xi1>
    %48 = "hivm.hir.vsel"(%47, %42, %3, %17) <{broadcast = array<i64>, operandSegmentSizes = array<i32: 3, 1, 0>, transpose = array<i64>}> : (tensor<1024xi1>, tensor<1024xf32>, f32, tensor<1024xf32>) -> tensor<1024xf32>
