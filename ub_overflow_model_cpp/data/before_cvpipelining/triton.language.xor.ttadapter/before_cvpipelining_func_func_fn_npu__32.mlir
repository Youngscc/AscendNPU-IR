...
"builtin.module"() ({
  ...
  ^bb0(%arg0: i64, %arg1: memref<?xi8>, %arg2: memref<?xi8>, %arg3: memref<?xi32>, %arg4: memref<?xi32>, %arg5: memref<?xi32>, %arg6: i32, %arg7: i32, %arg8: i32):
    ...
    %29 = "hivm.hir.vor"(%22, %25, %28) <{broadcast = array<i64>, operandSegmentSizes = array<i32: 2, 1, 0>, transpose = array<i64>}> : (tensor<1x8x1xi32>, tensor<1x8x1xi32>, tensor<1x8x1xi32>) -> tensor<1x8x1xi32>
    %30 = "hivm.hir.vand"(%22, %25, %27) <{broadcast = array<i64>, operandSegmentSizes = array<i32: 2, 1, 0>, transpose = array<i64>}> : (tensor<1x8x1xi32>, tensor<1x8x1xi32>, tensor<1x8x1xi32>) -> tensor<1x8x1xi32>
    %31 = "hivm.hir.vnot"(%30, %30) <{broadcast = array<i64>, operandSegmentSizes = array<i32: 1, 1, 0>, transpose = array<i64>}> : (tensor<1x8x1xi32>, tensor<1x8x1xi32>) -> tensor<1x8x1xi32>
    %32 = "hivm.hir.vand"(%31, %29, %26) <{broadcast = array<i64>, operandSegmentSizes = array<i32: 2, 1, 0>, transpose = array<i64>}> : (tensor<1x8x1xi32>, tensor<1x8x1xi32>, tensor<1x8x1xi32>) -> tensor<1x8x1xi32>
    %33 = "memref.reinterpret_cast"(%arg3, %19) <{operandSegmentSizes = array<i32: 1, 1, 0, 0>, static_offsets = array<i64: -9223372036854775808>, static_sizes = array<i64: 1, 8, 1>, static_strides = array<i64: 8, 16, 1>}> : (memref<?xi32>, index) -> memref<1x8x1xi32, strided<[8, 16, 1], offset: ?>>
    "hivm.hir.store"(%32, %33) : (tensor<1x8x1xi32>, memref<1x8x1xi32, strided<[8, 16, 1], offset: ?>>) -> ()
    "func.return"() : () -> ()
