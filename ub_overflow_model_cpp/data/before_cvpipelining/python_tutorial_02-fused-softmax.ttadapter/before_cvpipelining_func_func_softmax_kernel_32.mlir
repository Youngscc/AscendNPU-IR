...
"builtin.module"() ({
  ...
  ^bb0(%arg0: i64, %arg1: memref<?xi8>, %arg2: memref<?xi8>, %arg3: memref<?xf32>, %arg4: memref<?xf32>, %arg5: i32, %arg6: i32, %arg7: i32, %arg8: i32, %arg9: i32, %arg10: i32, %arg11: i32):
    ...
    ^bb0(%arg12: i32):
      ...
      %23 = "hivm.hir.vreduce"(%20, %22) <{arith = #hivm.reduce_op<max>, operandSegmentSizes = array<i32: 1, 1, 0, 0>, reduce_dims = array<i64: 0>, tie_break_left = true, unsigned_src = false}> : (tensor<1024xf32>, tensor<1xf32>) -> tensor<1xf32>
      %24 = "tensor.extract"(%23, %2) : (tensor<1xf32>, index) -> f32
      %25 = "tensor.empty"() : () -> tensor<1024xf32>
      %26 = "hivm.hir.vsub"(%20, %24, %25) <{broadcast = array<i64>, operandSegmentSizes = array<i32: 2, 1, 0>, transpose = array<i64>}> : (tensor<1024xf32>, f32, tensor<1024xf32>) -> tensor<1024xf32>
      %27 = "hivm.hir.vexp"(%26, %25) <{broadcast = array<i64>, operandSegmentSizes = array<i32: 1, 1, 0>, transpose = array<i64>}> : (tensor<1024xf32>, tensor<1024xf32>) -> tensor<1024xf32>
      %28 = "bufferization.alloc_tensor"() <{operandSegmentSizes = array<i32: 0, 0, 0>}> : () -> tensor<f32>
      %29 = "hivm.hir.vreduce"(%27, %22) <{arith = #hivm.reduce_op<sum>, operandSegmentSizes = array<i32: 1, 1, 0, 0>, reduce_dims = array<i64: 0>, tie_break_left = true, unsigned_src = false}> : (tensor<1024xf32>, tensor<1xf32>) -> tensor<1xf32>
      %30 = "tensor.extract"(%29, %2) : (tensor<1xf32>, index) -> f32
      %31 = "hivm.hir.vdiv"(%27, %30, %25) <{broadcast = array<i64>, isHP = false, isSigned = true, operandSegmentSizes = array<i32: 2, 1, 0>, transpose = array<i64>}> : (tensor<1024xf32>, f32, tensor<1024xf32>) -> tensor<1024xf32>
      %32 = "arith.muli"(%arg12, %arg6) <{overflowFlags = #arith.overflow<none>}> : (i32, i32) -> i32
      %33 = "arith.index_cast"(%32) : (i32) -> index
      %34 = "memref.reinterpret_cast"(%arg3, %33) <{operandSegmentSizes = array<i32: 1, 1, 0, 0>, static_offsets = array<i64: -9223372036854775808>, static_sizes = array<i64: 1024>, static_strides = array<i64: 1>}> : (memref<?xf32>, index) -> memref<1024xf32, strided<[1], offset: ?>>
      %35 = "tensor.extract_slice"(%31, %16) <{operandSegmentSizes = array<i32: 1, 0, 1, 0>, static_offsets = array<i64: 0>, static_sizes = array<i64: -9223372036854775808>, static_strides = array<i64: 1>}> : (tensor<1024xf32>, index) -> tensor<?xf32>
      %36 = "memref.subview"(%34, %16) <{operandSegmentSizes = array<i32: 1, 0, 1, 0>, static_offsets = array<i64: 0>, static_sizes = array<i64: -9223372036854775808>, static_strides = array<i64: 1>}> : (memref<1024xf32, strided<[1], offset: ?>>, index) -> memref<?xf32, strided<[1], offset: ?>>
