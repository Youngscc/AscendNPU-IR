"builtin.module"() ({
  ...
  ^bb0(%arg0: i64, %arg1: memref<?xi8>, %arg2: memref<?xi8>, %arg3: memref<?xi32>, %arg4: memref<?xi32>, %arg5: i32, %arg6: i32, %arg7: i32):
    ...
    "hivm.hir.load"(%2, %3) <{eviction_policy = #hivm.eviction_policy<EvictFirst>, init_out_buffer = false, may_implicit_transpose_with_last_axis = false, operandSegmentSizes = array<i32: 1, 1, 0, 0, 0, 0>, tcoretype = #hivm.tcore_type<VECTOR>}> : (memref<8x2x2x2x2x2x2xi32, strided<[64, 32, 16, 8, 4, 2, 1]>>, memref<8x2x2x2x2x2x2xi32>) -> ()
    ...
    %6 = "hivm.hir.vreduce"(%4, %5) <{arith = #hivm.reduce_op<xori>, operandSegmentSizes = array<i32: 1, 1, 0, 0>, reduce_dims = array<i64: 1>, tie_break_left = true, unsigned_src = false}> : (tensor<8x2x2x2x2x2x2xi32>, tensor<8x1x2x2x2x2x2xi32>) -> tensor<8x1x2x2x2x2x2xi32>
    ...
    %37 = "hivm.hir.vreduce"(%35, %36) <{arith = #hivm.reduce_op<xori>, operandSegmentSizes = array<i32: 1, 1, 0, 0>, reduce_dims = array<i64: 2>, tie_break_left = true, unsigned_src = false}> : (tensor<8x2x2x2x2x2x2xi32>, tensor<8x2x1x2x2x2x2xi32>) -> tensor<8x2x1x2x2x2x2xi32>
    ...
    %44 = "hivm.hir.vreduce"(%42, %43) <{arith = #hivm.reduce_op<xori>, operandSegmentSizes = array<i32: 1, 1, 0, 0>, reduce_dims = array<i64: 3>, tie_break_left = true, unsigned_src = false}> : (tensor<8x2x2x2x2x2x2xi32>, tensor<8x2x2x1x2x2x2xi32>) -> tensor<8x2x2x1x2x2x2xi32>
    ...
    %51 = "hivm.hir.vreduce"(%49, %50) <{arith = #hivm.reduce_op<xori>, operandSegmentSizes = array<i32: 1, 1, 0, 0>, reduce_dims = array<i64: 4>, tie_break_left = true, unsigned_src = false}> : (tensor<8x2x2x2x2x2x2xi32>, tensor<8x2x2x2x1x2x2xi32>) -> tensor<8x2x2x2x1x2x2xi32>
    ...
    %58 = "hivm.hir.vreduce"(%56, %57) <{arith = #hivm.reduce_op<xori>, operandSegmentSizes = array<i32: 1, 1, 0, 0>, reduce_dims = array<i64: 5>, tie_break_left = true, unsigned_src = false}> : (tensor<8x2x2x2x2x2x2xi32>, tensor<8x2x2x2x2x1x2xi32>) -> tensor<8x2x2x2x2x1x2xi32>
    ...
    %65 = "hivm.hir.vreduce"(%63, %64) <{arith = #hivm.reduce_op<xori>, operandSegmentSizes = array<i32: 1, 1, 0, 0>, reduce_dims = array<i64: 6>, tie_break_left = true, unsigned_src = false}> : (tensor<8x2x2x2x2x2x2xi32>, tensor<8x2x2x2x2x2x1xi32>) -> tensor<8x2x2x2x2x2x1xi32>
