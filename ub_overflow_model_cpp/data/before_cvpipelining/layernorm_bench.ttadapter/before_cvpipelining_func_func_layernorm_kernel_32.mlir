...
"builtin.module"() ({
  ...
  ^bb0(%arg0: i64, %arg1: memref<?xi8>, %arg2: memref<?xi8>, %arg3: memref<?xf32>, %arg4: memref<?xf32>, %arg5: memref<?xf32>, %arg6: memref<?xf32>, %arg7: i32, %arg8: i32, %arg9: f32, %arg10: i32, %arg11: i32, %arg12: i32):
    ...
    %23 = "affine.max"(%22) <{map = #map}> : (index) -> index
    %24 = "affine.min"(%23) <{map = #map1}> : (index) -> index
    ...
    %31 = "hivm.hir.vreduce"(%28, %30) <{arith = #hivm.reduce_op<sum>, operandSegmentSizes = array<i32: 1, 1, 0, 0>, reduce_dims = array<i64: 0>, tie_break_left = true, unsigned_src = false}> : (tensor<2048xf32>, tensor<1xf32>) -> tensor<1xf32>
    ...
    %41 = "hivm.hir.vreduce"(%38, %40) <{arith = #hivm.reduce_op<sum>, operandSegmentSizes = array<i32: 1, 1, 0, 0>, reduce_dims = array<i64: 0>, tie_break_left = true, unsigned_src = false}> : (tensor<2048xf32>, tensor<1xf32>) -> tensor<1xf32>
    ...
    "hivm.hir.load"(%59, %60, %3, %2, %25) <{eviction_policy = #hivm.eviction_policy<EvictFirst>, init_out_buffer = true, may_implicit_transpose_with_last_axis = false, operandSegmentSizes = array<i32: 1, 1, 1, 1, 0, 1>, pad_mode = #hivm.padmode<PadValue>, tcoretype = #hivm.tcore_type<VECTOR>}> : (memref<?xf32, strided<[1]>>, memref<?xf32, strided<[1]>>, f32, index, i1) -> ()
    ...
    "hivm.hir.load"(%64, %65, %3, %2, %25) <{eviction_policy = #hivm.eviction_policy<EvictFirst>, init_out_buffer = true, may_implicit_transpose_with_last_axis = false, operandSegmentSizes = array<i32: 1, 1, 1, 1, 0, 1>, pad_mode = #hivm.padmode<PadValue>, tcoretype = #hivm.tcore_type<VECTOR>}> : (memref<?xf32, strided<[1]>>, memref<?xf32, strided<[1]>>, f32, index, i1) -> ()
