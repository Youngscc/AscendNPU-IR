...
"builtin.module"() ({
  ...
  ^bb0(%arg0: i64, %arg1: memref<?xi8>, %arg2: memref<?xi8>, %arg3: memref<?xi32>, %arg4: memref<?xi32>, %arg5: memref<?xi8>, %arg6: i32, %arg7: i32, %arg8: i32):
    ...
    ^bb0(%arg9: i32):
      ...
      %35 = "memref.reinterpret_cast"(%arg5, %17) <{operandSegmentSizes = array<i32: 1, 1, 0, 0>, static_offsets = array<i64: -9223372036854775808>, static_sizes = array<i64: 32>, static_strides = array<i64: 1>}> : (memref<?xi8>, index) -> memref<32xi8, strided<[1], offset: ?>>
      %36 = "tensor.empty"() : () -> tensor<32xi8>
      %37 = "hivm.hir.vcast"(%34, %36) <{broadcast = array<i64>, cast = #hivm.cast<cast_signed>, operandSegmentSizes = array<i32: 1, 1, 0>, round_mode = #hivm.round_mode<rint>, transpose = array<i64>}> : (tensor<32xi1>, tensor<32xi8>) -> tensor<32xi8>
      %38 = "tensor.extract_slice"(%37, %23) <{operandSegmentSizes = array<i32: 1, 0, 1, 0>, static_offsets = array<i64: 0>, static_sizes = array<i64: -9223372036854775808>, static_strides = array<i64: 1>}> : (tensor<32xi8>, index) -> tensor<?xi8>
      %39 = "memref.subview"(%35, %23) <{operandSegmentSizes = array<i32: 1, 0, 1, 0>, static_offsets = array<i64: 0>, static_sizes = array<i64: -9223372036854775808>, static_strides = array<i64: 1>}> : (memref<32xi8, strided<[1], offset: ?>>, index) -> memref<?xi8, strided<[1], offset: ?>>
      "hivm.hir.store"(%38, %39) : (tensor<?xi8>, memref<?xi8, strided<[1], offset: ?>>) -> ()
      "scf.yield"() : () -> ()
    }) : (i32, i32, i32) -> ()
    "func.return"() : () -> ()
