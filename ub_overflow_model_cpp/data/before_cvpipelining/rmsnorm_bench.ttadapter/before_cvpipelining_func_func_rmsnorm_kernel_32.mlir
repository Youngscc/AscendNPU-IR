...
"builtin.module"() ({
  ...
  ^bb0(%arg0: i64, %arg1: memref<?xi8>, %arg2: memref<?xi8>, %arg3: memref<?xf32>, %arg4: memref<?xf32>, %arg5: memref<?xf32>, %arg6: i32, %arg7: i32, %arg8: f32, %arg9: i32, %arg10: i32, %arg11: i32):
    ...
    %16 = "affine.max"(%15) <{map = #map}> : (index) -> index
    %17 = "affine.min"(%16) <{map = #map1}> : (index) -> index
    ...
    %28 = "hivm.hir.vreduce"(%25, %27) <{arith = #hivm.reduce_op<sum>, operandSegmentSizes = array<i32: 1, 1, 0, 0>, reduce_dims = array<i64: 0>, tie_break_left = true, unsigned_src = false}> : (tensor<2048xf32>, tensor<1xf32>) -> tensor<1xf32>
