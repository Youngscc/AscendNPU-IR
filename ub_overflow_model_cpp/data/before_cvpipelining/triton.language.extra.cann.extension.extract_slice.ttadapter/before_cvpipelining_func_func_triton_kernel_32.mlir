...
"builtin.module"() ({
  ...
  ^bb0(%arg0: i64, %arg1: memref<?xi8>, %arg2: memref<?xi8>, %arg3: memref<?xf32>, %arg4: memref<?xf32>, %arg5: memref<?xf32>, %arg6: i32, %arg7: i32, %arg8: i32, %arg9: i32):
    ...
    %29 = "tensor.extract_slice"(%23, %12) <{operandSegmentSizes = array<i32: 1, 1, 0, 0>, static_offsets = array<i64: -9223372036854775808>, static_sizes = array<i64: 32>, static_strides = array<i64: 1>}> {DiscreteMemAccess} : (tensor<1024xf32>, index) -> tensor<32xf32>
    %30 = "tensor.extract_slice"(%28, %12) <{operandSegmentSizes = array<i32: 1, 1, 0, 0>, static_offsets = array<i64: -9223372036854775808>, static_sizes = array<i64: 32>, static_strides = array<i64: 1>}> {DiscreteMemAccess} : (tensor<1024xf32>, index) -> tensor<32xf32>
    ...
    %33 = "memref.reinterpret_cast"(%arg5, %12) <{operandSegmentSizes = array<i32: 1, 1, 0, 0>, static_offsets = array<i64: -9223372036854775808>, static_sizes = array<i64: 32>, static_strides = array<i64: 1>}> : (memref<?xf32>, index) -> memref<32xf32, strided<[1], offset: ?>>
    %34 = "affine.apply"(%12) <{map = #map3}> : (index) -> index
    %35 = "affine.min"(%34, %17) <{map = #map1}> : (index, index) -> index
    %36 = "affine.apply"(%35, %12) <{map = #map2}> : (index, index) -> index
    %37 = "tensor.extract_slice"(%32, %36) <{operandSegmentSizes = array<i32: 1, 0, 1, 0>, static_offsets = array<i64: 0>, static_sizes = array<i64: -9223372036854775808>, static_strides = array<i64: 1>}> : (tensor<32xf32>, index) -> tensor<?xf32>
    %38 = "memref.subview"(%33, %36) <{operandSegmentSizes = array<i32: 1, 0, 1, 0>, static_offsets = array<i64: 0>, static_sizes = array<i64: -9223372036854775808>, static_strides = array<i64: 1>}> : (memref<32xf32, strided<[1], offset: ?>>, index) -> memref<?xf32, strided<[1], offset: ?>>
