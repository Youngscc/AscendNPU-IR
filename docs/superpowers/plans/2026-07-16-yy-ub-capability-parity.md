...
- Keep `ub_overflow_model_cpp/output/` untracked.
...
**Files:**
- Create: `ub_overflow_model_cpp/tests/capability_parity.tsv`
- Create: `ub_overflow_model_cpp/src/pipeline/modeling_result.hpp`
- Create: `ub_overflow_model_cpp/src/ir/post_pipeline_ir_utils.hpp`
...
**Files:**
- Create: `ub_overflow_model_cpp/src/passes/tile_cube_vector_loop.hpp`
- Modify: `ub_overflow_model_cpp/src/pipeline/cvpipelining_ub_pipeline.hpp`
- Test: `ub_overflow_model_cpp/tests/test_capability_parity.cpp`
...
**Files:**
- Create: `ub_overflow_model_cpp/src/passes/loop_invariant_subset_hoisting.hpp`
- Extend: `ub_overflow_model_cpp/src/passes/inline_scope.hpp`
- Modify: `ub_overflow_model_cpp/src/pipeline/cvpipelining_ub_pipeline.hpp`
...
**Files:**
- Modify: `ub_overflow_model_cpp/tests/test_capability_parity.cpp`
- Modify: `ub_overflow_model_cpp/tests/run_tests.sh`
- Modify: `ub_overflow_model_cpp/config/post_cvpipeline_manifest.tsv`
...
**Files:**
- Modify: `ub_overflow_model_cpp/HANDOFF.md`
